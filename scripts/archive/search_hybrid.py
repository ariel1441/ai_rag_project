...
This fixes the issue of missing relevant results!
"""
import psycopg2
import numpy as np
...
print("=" * 70)
print()
print("This combines keyword filtering with semantic ranking")
...
try:
    ...
    # For "פניות שקשורות למיילים", extract "מייל"
        ...
        cursor.execute(f"""
            SELECT 
                ...
                CASE 
                    ...
                    THEN 1.2  -- Boost email-related results
                    ELSE 1.0
                END as boost
    ...
    if results:
        ...
        print()
        print("✅ Hybrid search: Keyword filter + Semantic ranking")
    else:
