"""
Search script with RTL (Hebrew) display fix.
This reverses Hebrew text segments for correct display in LTR terminals.
"""
import psycopg2
import numpy as np
...
print("=" * 70)
print("Semantic Search (with RTL fix)")
print("=" * 70)
print()
print("Hebrew text will be reversed for correct display in terminal.")
print()
