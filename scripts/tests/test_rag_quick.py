"""
Quick RAG Test - Minimal, Fast Verification
This test loads the model with float16 (skips 4-bit) and tests ONE query.
Designed to actually complete without hanging.
"""
import sys
import time
...
def main():
    print("="*80)
    print("QUICK RAG TEST - FLOAT16 ONLY")
    print("="*80)
    print()
    print("This test:")
    print("  ✅ Skips 4-bit quantization (avoids Windows CPU hang)")
    print("  ✅ Uses float16 directly (~7-8GB RAM)")
    print("  ✅ Tests ONE query to verify RAG works")
    print()
    print("Expected time:")
    ...
    # Load LLM model (float16 only - no 4-bit attempt)
    print("Step 3: Loading LLM model with float16...")
    print("="*80)
    ...
    try:
        ...
        print()
        print("="*80)
        print("✅ TEST PASSED - RAG SYSTEM WORKS!")
        print("="*80)
